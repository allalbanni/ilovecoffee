            ...
            with st.spinner("Processing PDF..."):
                try:
                    ...
                    with tempfile.TemporaryDirectory() as tmpdir:
                        ...
                        markscheme_path = os.path.join(tmpdir, f"markscheme.{markscheme_file.name.split('.')[-1]}")
                        ...
                        markscheme_ext = markscheme_file.name.split('.')[-1].lower()
                        ...
                        marking_engine = MarkingEngine(
                            ...
                            mode=marking_mode.lower().split()[0]
                        )
